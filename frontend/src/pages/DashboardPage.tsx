    ...
    <div className="flex h-full flex-col gap-6 overflow-auto p-6">
        ...
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Topologies</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Active Hosts</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Assigned Agents</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Running Sessions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-4 overflow-auto">
          <h2 className="text-lg font-semibold">Select Topology</h2>
        ...
        {selectedTopology ? (
          <div className="flex flex-col gap-4 overflow-auto">
            {/* Agent Selection */}
            <div>
              <h2 className="text-lg font-semibold mb-3">Select Agents</h2>
            ...
            <div className="flex-1 flex flex-col min-h-0">
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-lg font-semibold">Select Hosts</h2>
                <div className="flex gap-2">
                  <button
          ...
          <div className="flex items-center justify-center">
            <p className="text-gray-500">Select a topology to manage agents</p>
          </div>
        )}
      </div>
    </div>
